...
public class UserDataCollection 
{
	  ...
	  //UserDataCollection(null, int, int, int, int, int, 
	  //null, String, null, null, null, 
	  //String, Date, null, null, null, null, boolean) 
	  public UserDataCollection(Integer udcId,Integer projectId,Integer pageId,Double positionId,Integer controlId,
			   Integer valueId,InputStream imageValue,String textValue,BigDecimal numberValue,Date dateValue,Boolean booleanValue,
	...
	public void setUdcId(Integer udcId) {
		this.udcId = udcId;
	}
	...
	public String toString() {
		return "UserDataCollection [udcId=" + udcId + ", projectId=" + projectId + ", pageId=" + pageId
				+ ", positionId=" + positionId + ", controlId=" + controlId + ", valueId=" + valueId + ", imageValue="
				+ imageValue + ", textValue=" + textValue + ", numberValue=" + numberValue + ", dateValue=" + dateValue
	...
	public int hashCode() {
		...
		result = prime * result + ((udcId == null) ? 0 : udcId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserDataCollection other = (UserDataCollection) obj;
		if (active == null) {
		...
		if (udcId == null) {
			if (other.udcId != null)
				return false;
		} else if (!udcId.equals(other.udcId))
			return false;
		if (updateTime == null) {
